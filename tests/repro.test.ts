import { bollinger_config, config, config_payload, donchian_config, classic_config, keltner_config } from "./utils";
import fs from 'fs';
...
describe("WASM Module", () => {
  ...
  describe("Custom Strategy", () => {
    test.only("can run execute", async () => {        
      ...
      (JSON.stringify([...prices3]), positions, currentTick, timeSinceLastExecution);
